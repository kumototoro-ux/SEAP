...
export const createGradingSheetSchema = z.object({
  ...
  maxScore: z.number().positive('الدرجة الكلية لهذا التقييم مطلوبة ويجب أن تكون أكبر من صفر').max(1000), // 🆕 قرار المعلم دائماً لحظة الإنشاء — لا علاقة لها بوزن نوع التقييم بالإعدادات إطلاقاً، ولا سحب تلقائي بعد الآن
