...
export const addEmployeeSchema = z.object({
  ...
  nameEn: z.string().trim().min(2, 'الاسم بالإنجليزي مطلوب').max(100), // 🆕 أصبح إجبارياً
  ...
  ], { errorMap: () => ({ message: 'يجب اختيار دور صحيح' }) }), // 🆕 قائمة محدَّدة بدل نص حر — يمنع دوراً غير موجود بالخطأ
