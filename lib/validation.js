...
export const addEmployeeSchema = z.object({
  nameAr: z.string().trim().min(2, 'الاسم قصير جداً').max(100),
  nameEn: z.string().trim().max(100).optional().or(z.literal('')),
  // ⚠️ رقم الهوية/الإقامة/الجواز: مزيج أحرف وأرقام بأي طول معقول (4-20) —
  // ليس كل الموظفين/الطلاب/أولياء الأمور سعوديين بهوية 10 أرقام بالضرورة
