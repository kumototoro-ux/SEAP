...
// 🆕 إعادة تسمية أسبوع دراسي واحد (تسمية يدوية فقط، لا تغيّر التواريخ)
export const renameWeekSchema = z.object({
  id: z.union([z.string(), z.number()]),
  label: z.string().trim().min(1, 'اسم الأسبوع مطلوب').max(100),
});
