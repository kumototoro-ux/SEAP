...
// 🆕 مصفوفة توزيع المواد (فرع/صف/شعبة/مادة)
export const addMatrixEntrySchema = z.object({
...
// 🆕 توزيع الدرجات (نوع التقييم ودرجته من 100 لكل مادة)
export const addGradeDistributionSchema = z.object({
  subject: z.string().min(1, 'المادة مطلوبة'),
  evalType: z.string().min(1, 'نوع التقييم مطلوب'),
  maxScore: z.number().min(0).max(100, 'الدرجة يجب ألا تتجاوز 100'),
});
