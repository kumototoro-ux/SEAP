...
// 🆕 إعادة تسمية وتخصيص نوع أسبوع دراسي (دراسي/إجازة/اختبار شهري/اختبار نهائي)
// — label نص حر (يُستخدَم لاسم الإجازة أيضاً، مثل "إجازة مطر" أو "اليوم الوطني")
export const updateWeekSchema = z.object({
  id: z.union([z.string(), z.number()]),
  label: z.string().trim().min(1, 'التسمية مطلوبة').max(100),
